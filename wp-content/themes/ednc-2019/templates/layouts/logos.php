...
<div class="logo-section">
  <ul class="logos">
    ...
    <li><img src="<?php echo Assets\asset_path('images/Blue-Cross-Blue-Sheild-NC-Logo.png'); ?>" width="130" alt="Blue Cross Blue Shield" /></a></li>
    <li><img src="<?php echo Assets\asset_path('images/logo-belk-foundation.png'); ?>" width="130" alt="Belk Foundation" /></li>
    <li><img src="<?php echo Assets\asset_path('images/kenan.png'); ?>" width="170" alt="The William R. Kenan, Jr. Charitable Trust" /></li>
    ...
    <li><img src="<?php echo Assets\asset_path('images/BelkEndowment_logo.png'); ?>" width="200" alt="John M. Belk Endowment" /></li>
    </ul>
</div>
